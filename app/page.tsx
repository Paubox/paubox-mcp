      ...
      <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-blue-50 to-indigo-100 p-4">
        <div className="w-full max-w-4xl space-y-8">
          <div className="text-center">
            ...
            <h1 className="text-4xl font-bold tracking-tight text-slate-900 sm:text-5xl">MCP Server</h1>
            <p className="mt-4 text-lg text-slate-600">
              Official MCP server which allows AI agents to interact with Paubox Email API. HITRUST certified.
            </p>
          </div>
          ...
          <Card className="border-2 border-[#2E70FF]/20 shadow-lg">
            ...
            >
              ...
              >
                <Shield className="h-5 w-5" style={{ color: pauboxColors.primary[500] }} />
                Secure Email API
              </CardTitle>
              ...
              <div className="space-y-4">
                ...
                >
                  <h3 className="flex items-center gap-2 font-medium" style={{ color: pauboxColors.text.primary }}>
                    <Mail className="h-4 w-4" style={{ color: pauboxColors.primary[500] }} />
                    send_secure_email
                  </h3>
          ...
          <Card className="border-blue-200 bg-blue-50">
            ...
            >
              <p className="text-sm" style={{ color: pauboxTheme.card.footer.text }}>
