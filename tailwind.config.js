...
// includes a sensible set of `content` globs so Tailwind can tree-shake
// unused styles from pages, components, and the `app` directory. Feel
// free to adjust these globs if your project structure differs.
//
